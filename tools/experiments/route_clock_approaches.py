...
"""Guarded all-front clock revision; every placement/route gate precedes writing."""
import hashlib
import faulthandler
import json
import math
...
POSES = {
    "Y1": (92.574801, 98.202596, 90),
    "C2": (90.603600, 97.052450, 90),
    "C3": (90.649181, 99.199331, 270),
...
ROUTES = [
    ...
    ("C3.2", "Y1.1", .1778,
     [(90.82, 99.599331), (90.82, 100.1), (91.02, 100.3),
      (92.7, 100.3), (93.449801, 99.550199)]),
    ("Y1.1", "R6.1", .1778,
     [(94.30, 99.152596), (94.754695, 98.697901)]),
    ("C2.1", "C3.1", .2, [(90.603600, 98.753750)]),
    ("C3.1", "Y1.4", .2, [(91.346536, 98.799331)]),
    ("Y1.3", "IC1.20", .1778,
     [(91.699801, 98.05), (95.42, 98.05), (95.42, 99.4)]),
    ("IC1.21", "R6.2", .1778, [(94.911513, 99.8)]),
    ("C2.1", "Y1.2", .2,
     [(89.95, 97.452450), (89.95, 96.40), (90.25, 96.10), (93.449801, 96.10)]),
    ("Y1.2", "IC1.19", .1778,
     [(95.3, 97.052596), (95.81, 97.562596), (95.81, 99.0)]),
]
